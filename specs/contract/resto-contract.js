...
const itActsAsFavoriteRestoModel = (favoriteResto) => {
  it('should return the restaurant that has been added', async () => {
    ...
    expect(await favoriteResto.loadResto(1))
      .toEqual({ id: 1 });
    expect(await favoriteResto.loadResto(2))
      .toEqual({ id: 2 });
    expect(await favoriteResto.loadResto(3))
      .toEqual(undefined);
  });
  it('should refuse a restaurant from being added if it does not have the correct property', async () => {
    favoriteResto.addRestaurant({ aProperty: 'property' });
    expect(await favoriteResto.loadRestoList())
      .toEqual([]);
  });
